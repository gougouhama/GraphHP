...
public class GraphJob extends BSPJob {
  ...
  public void setAggregatorClass(@SuppressWarnings("unchecked") Class<? extends Aggregator>... cls) {
    String classNames = "";
  ...
  public void setMaxIteration(int maxIteration) {
	...
	public void setBounaryVertexParticipateLocalphase(boolean participateLocalphase) {
		conf.setBoolean("hama.graph.boundary.vertex.participate.localphase",participateLocalphase);
	}
