...
public interface VertexInterface<V extends Writable, E extends Writable, M extends Writable> {
  ...
  /**
   * Sends a local message to another vertex.
   */
  ...
  /**
   * Sends a local message to neighbors
   */
  ...
  /**
   * Sends a local message to the given destination vertex by ID and the message value
   */
  public void sendLocalMessage(V destinationVertexID, M msg) throws IOException;
